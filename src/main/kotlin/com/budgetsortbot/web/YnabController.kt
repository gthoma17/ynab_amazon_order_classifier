...
import com.budgetsortbot.web.dto.YnabBudgetResponse
import com.budgetsortbot.web.dto.YnabCategoryResponse
...
class YnabController(
    ...
    fun getCategories(): List<YnabCategoryResponse> {
        ...
        val budgetId =
            configService.getValue(ConfigService.YNAB_BUDGET_ID)
