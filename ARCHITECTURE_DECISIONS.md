...
| 18 | Cassette Futurism design system | All UI must follow the Cassette Futurism visual language documented in `UI_DESIGN_PRINCIPLES.md`. | [ADR-0008](docs/ADRs/20260408_cassetteFuturismUiDesignSystem.md#1-persistent-panel-pattern) |
